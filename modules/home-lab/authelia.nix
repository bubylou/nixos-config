    ...
    services = {
      authelia.instances.main = {
        ...
        environmentVariables = {
          AUTHELIA_AUTHENTICATION_BACKEND_LDAP_PASSWORD_FILE = "/etc/nixos/secrets/lldap-bind-credentials.secret";
          AUTHELIA_NOTIFIER_SMTP_PASSWORD_FILE = "/etc/nixos/secrets/brevo-smtp-credentials.secret";
        };
        ...
        settings = {
          ...
          access_control = {
            ...
            rules = [
              ...
              {
                domain_regex = "(prowlarr|radarr|radarr-4k|sonarr|qbittorrent).${config.home-lab.domain}$";
                policy = "bypass";
                resources = ["^/api.*" "/ping"];
              }
              {
